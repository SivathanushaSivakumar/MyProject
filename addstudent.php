            ...
            <div class="row gx-5">
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        <h1 class="mb-4">Update Daily Medical Details</h1>
                        <form action="insertstudent.php" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" name = "year" style="height: 55px;">
                                ...
                                <div class="col-12 col-sm-6">
                                        ...
                                        <input type="text" name = "res"
                                            ...
                                            placeholder="Reason" style="height: 55px;">
