...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="checkapoinment.php" class="nav-item nav-link">Check apoinment</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="admin.php" class="dropdown-item">Add Student Details</a>
    ...
    <!-- view medical report -->
    <center>
    <h1 class="mb-4" style="color: blue;">View Student Daily Medical Details</h1>
</center>
            ...
            <div class="row gx-5">
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        <h1 class="mb-4">View Today Medical Details</h1>
                        <form method="post">
                            <div class="row g-3">
                                
                                <div class="col-12 col-sm-12">
                                    <input type="date" name = "dates"  class="form-control bg-light border-0" placeholder="Enter date" style="height: 55px;">
                                </div>
                                
                                <div class="col-3">
                                    <button class="btn btn-primary w-100 py-3" type="submit" name = "go"> Search </button>
                                </div>
                            </div>
                        </form>
                            ...
                            <table width="50%" border="1" cellpadding="5" cellspacing="5">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Year</th>
                                        <th>Date</th>
                                        <th>Reasons that get to medicine</th>
                                ...
                                <?php
                                    ...
                                    $sql = "select * from daily where TE_Number = '$no'";
                                    ...
                                    while($row = mysqli_fetch_array($query))
                                    {
                                        ...
                                        <?php
                                            ...
                                            $sql = "select * from daily where Date = '$date'";
