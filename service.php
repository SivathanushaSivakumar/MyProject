            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">Students can get the immediate treatment in emergency situation.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">Students can get the ambulance service in any time.</p>
                        <a class="btn btn-lg btn-primary rounded-pill" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">Students can get the medicine and pharmacy facilities in our medical centre.</p>
                        <a class="btn btn-lg btn-primary rounded-pill" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="row g-0 bg-light rounded overflow-hidden">
                    ...
                    <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                        <div class="mt-auto p-4">
                            <h3>Dr.Sagar de Silve</h3>
                            <h6 class="fw-normal fst-italic text-primary mb-4">Medical doctor in chearge</h6>
                            <p class="m-0">Medical health centre,  University of srijeyewardenepura. </p>
                        </div>
