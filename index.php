        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5" style="border-color: rgba(256, 256, 256, .3) !important;">Welcome To Fotmedi</h5>
                    <h1 class="display-1 text-white mb-md-4">Best Healthcare Solution In our faculty</h1>
                    <div class="pt-2">
