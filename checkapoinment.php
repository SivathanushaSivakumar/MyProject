    ...
    <div class="container py-5" >
            <div class="row gx-5">
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        <h1 class="mb-4">View Today Appoinment</h1>
                        <form method="post">
                            <div class="row g-3">
                                
                                <div class="col-12 col-sm-12">
                                    <input type="date" name = "date" class="form-control bg-light border-0" placeholder="Enter date" style="height: 55px;">
                                </div>
                        ...
                        <form method="post">
                            ...
                            <table width="50%" border="1" cellpadding="5" cellspacing="5">
                                ...
                                <?php
                                    ...
                                    $sql = "select * from apoinment where TE_Number = '$no'";
                                    ...
                                    while($row = mysqli_fetch_array($query))
                                    {
                                        ...
                                        <?php
                                            ...
                                            $sql = "select * from apoinment where Date = '$date'";
        ...
        <div class="container py-5" >
            <div class="row gx-5">
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        <h1 class="mb-4">View Appoinment Within Student Id</h1>
                        <form method="post">
                            <div class="row g-3">
