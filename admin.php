                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="checkapoinment.php" class="nav-item nav-link">Check apoinment</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="#update" class="dropdown-item">Add Student Details</a>
                                <a href="addstudent.php" class="dropdown-item">Add Daily Medical Details</a>
                            </div>
                        </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-6">
                    <div class="bg-white text-center rounded p-5">
                        <h1 class="mb-4">Add Student & Medical Details</h1>
                        <form action = "insertmedical.php" method = "post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select name = "year" class="form-select bg-light border-0" style="height: 55px;">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input name = "te" type="text" class="form-control bg-light border-0" placeholder="TE number" style="height: 55px;">
                                </div>
                                
                                <div class="col-12 col-sm-12">
                                    <input name = "address" type="text" class="form-control bg-light border-0" placeholder="Address" style="height: 55px;">
                                </div>
                                
                                <div class="col-12 col-sm-12">
                                    <input name = "details" type="text" class="form-control bg-light border-0" placeholder="Past Medical Details" style="height: 55px;">
                                </div>

                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit" name ="upload"> Done </button>
                                </div>
                            </div>
                        </form>
                    </div>
