<?php 
	...
	if($_SERVER['REQUEST_METHOD']=="POST"){
		...
		elseif(empty($username) && empty($password)){
			...
			$error = "Fill the area of username and password";
		}
		else
		{
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="adminLogin.php" class="nav-item nav-link active">Admin</a>
                        ...
                        <form method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-12">
                                    <input type="text" name = "user_name" class="form-control bg-light border-0" placeholder="User Name" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-12">
                                    <input type="text" name = "password" class="form-control bg-light border-0" placeholder="Password" style="height: 55px;">
                                </div>
                                
                                <div class="col-12" >
                                    <button class="btn btn-primary w-100 py-3" type="submit" name = "login" value = "Login"> Login </button>
                                </div>
                            </div>
                        </form>
                    </div>
