                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Make apoinment & find the team</a>
            ...
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="mb-4">
                        ...
                        <h1 class="display-4">Make An Appointment For You</h1>
                    </div>
                    <p class="text-white mb-5">Students, you can make appointment for your medical needs . you can make appointment in the week days ,lectures days. the time period is morning 8am to 5pm. if you face any dificulties in this appointment call 0112548960 to confire your appointment. </p>
                    ...
                    <div class="bg-white text-center rounded p-5">
                        ...
                        <form action="insert.php" method = "post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-light border-0" name="te" placeholder="TE number" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
